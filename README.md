...
| u202315890 | López Roman, Franco Mauricio         |
| u202314115 | Pariachi Limahuaya, Sebastian Ubaldo |
| u202312932 | Ramirez Carrasco, Ariana Lizeth      |
...
| TB2 | 08/07/2026 | - Baca Camargo, Vitaly Arturo<br>- Huapaya Galindo, Dyron<br>- Pariachi Limahuaya, Sebastián Ubaldo<br>- Ramírez Carrasco, Ariana Lizeth<br>- López Roman, Franco Mauricio | Se agregaron los siguientes contenidos correspondientes al 4. Cuarto Hito: TB2. Release Review (Semana 15):<br>- Versión actualizada de Registro de Versiones del Informe, Project Report Collaboration Insights y Sección Student Outcome.<br>- Versión corregida y mejorada de artefactos previamente presentados.<br>- Landing Page desplegado.<br>- Backend desplegado al 100% en un sitio público con su documentación.<br>- Aplicación con todas las funcionalidades indicadas en el product backlog (frontend completo de FerovaFamilia y FerovaClinic en sus perfiles administrativo y médico).<br>- Aplicación desplegada en Firebase App Distribution.<br>- Versión final del video con la validación de la aplicación.<br>- Versión final del video About-the-Product.<br>- Versión final del video About-the-Team.<br>Capítulo IV: Product Implementation & Validation (Sprint 3)<br>Conclusiones<br>Bibliografía<br>Anexos |
...
# [Video About the team](video-about-team.md#video-about-team)
